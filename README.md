Демон для проекта "Часы Уизли". Отлеживает изменения координат пользователей в FiriStore и отправляет клиенту пакет с id пользователя и id сегмента часов по постоянному сокетному соединению
